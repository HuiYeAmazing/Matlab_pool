...
inway = 'E:\Ye_data\BGC_input40km\BGC_output\output1km\outsprau';
outway = 'E:\Ye_data\BGC_input40km\BGC_output\yrfloat1km\yrsprau';
disp('sum')
%写头文件
npixels = 101;
nlines = 64;
...
%读入模型输出文件
list = dir('E:\Ye_data\BGC_input40km\BGC_output\output1km\outsprau\*.annout.ascii');
ff_m = list(1).name;
