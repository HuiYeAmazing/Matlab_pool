...
inway = 'E:\Ye_data\BGC_input40km\BGC_output\output1km\outnongra';
outway = 'E:\Ye_data\BGC_input40km\BGC_output\yrfloat1km\yrnongra';
disp('nongra')
%写头文件
npixels = 101;
nlines = 64;
...
%读入模型输出文件
list = dir('E:\Ye_data\BGC_input40km\BGC_output\output1km\outnongra\*.annout.ascii');
ff_m = list(1).name;
